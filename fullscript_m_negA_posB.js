define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			[//Each object in this array defines a block
				{
					...
					singleAttTrials : 7, //Number of trials of the attribute that does not share key with the category (in a mini block).
					sharedAttTrials : 7, //Number of trials of the attribute that shares key with the category (in a mini block).
			...
			switchSideBlock : 0, //By default, we switch on block 4 (i.e., after blocks 2 and 3 showed the first pairing condition).
			...
			instTemplatePractice : '<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);' +
  				'text-align:center;font-family:arial;max-width:80%;padding:20px;">' +
    			'In this memory task you will see words and players appear in the center of the screen. Your task is to sort the right word and player in the correct group using the keys shown above.<br/><br/>' +
				'<b>Please take your time</b>, it is most important that you place the words and players correctly.<br/><br/>' +
