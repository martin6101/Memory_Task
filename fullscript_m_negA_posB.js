	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			instTemplatePractice : '<div style="text-align:center; font-family:arial">' +
    			'In this memory task you will see words and players appear in the center of the screen, one at a time. Your task is to sort the right word and player in the correct group using the keys shown above.<br/><br/>' +
